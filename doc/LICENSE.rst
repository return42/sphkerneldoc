...
::
           ...
           dbtools:: a usefull base for DocBook to reST migration

                       Copyright (C) 2016  Markus Heiser
   ...
   der Lizenz oder (nach Ihrer Wahl) jeder neueren veröffentlichten Version,
   weiterverbreiten und/oder modifizieren.

   Dieses Programm wird in der Hoffnung, dass es nützlich sein wird, aber OHNE
   JEDE GEWÄHRLEISTUNG, bereitgestellt; sogar ohne die implizite Gewährleistung
