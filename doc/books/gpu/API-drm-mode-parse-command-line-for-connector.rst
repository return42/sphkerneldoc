...
This parses ``mode_option`` command line modeline for modes and options to configure the connector. If ``mode_option`` is NULL the default command line modeline in fb_mode_option
