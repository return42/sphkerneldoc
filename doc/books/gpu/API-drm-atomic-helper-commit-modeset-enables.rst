...
For compatibility with legacy crtc helpers this should be called after ``drm_atomic_helper_commit_planes``, which is what the default commit function does. But drivers with
