...
Use this instead of ``platform_driver_register`` when you know the device is not hotpluggable and has already been registered, and you want to remove its run-once ``probe``
