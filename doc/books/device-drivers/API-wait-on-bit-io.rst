...
Use the standard hashed waitqueue table to wait for a bit to be cleared. This is similar to ``wait_on_bit``, but calls ``io_schedule`` instead of ``schedule`` for the actual
waiting.
