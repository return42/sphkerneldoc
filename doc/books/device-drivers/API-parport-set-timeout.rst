...
This sets the inactivity timeout for a particular device on a port. This affects functions like ``parport_wait_peripheral``. The special value 0 means not to call ``schedule``
while dealing with this device.
