...
``data``
    ...
    related functionality which can be referenced using this pointer. The callback function can access the memory via the “data” field in the ``crypto_async_request`` data
    structure provided to the callback function.
