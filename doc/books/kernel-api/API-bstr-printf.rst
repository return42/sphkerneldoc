...
This function like C99 vsnprintf, but the difference is that vsnprintf gets arguments from stack, and bstr_printf gets arguments from ``bin_buf`` which is a binary buffer that
generated by vbin_printf.
