...
This function creates a file in debugfs with the given name that exports ``blob``->data as a binary blob. If the ``mode`` variable is so set it can be read from. Writing is not
supported.
