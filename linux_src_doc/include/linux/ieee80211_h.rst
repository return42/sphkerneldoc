...
.. _`ieee80211_he_cap_elem`:

struct ieee80211_he_cap_elem
============================

.. c:type:: struct ieee80211_he_cap_elem

    HE capabilities element

.. _`ieee80211_he_cap_elem.definition`:
...
.. _`ieee80211_he_cap_elem.members`:
...
.. _`ieee80211_he_cap_elem.description`:
...
.. _`ieee80211_he_mcs_support`:

enum ieee80211_he_mcs_support
=============================

.. c:type:: enum ieee80211_he_mcs_support

    HE MCS support definitions

.. _`ieee80211_he_mcs_support.definition`:
...
.. _`ieee80211_he_mcs_support.constants`:
...
IEEE80211_HE_MCS_SUPPORT_0_11
    MCSes 0-11 are supported

IEEE80211_HE_MCS_NOT_SUPPORTED
    This number of streams isn't supported

.. _`ieee80211_he_mcs_support.description`:

Description
-----------

These definitions are used in each 2-bit subfield of the rx_mcs\_\*
and tx_mcs\_\* fields of \ :c:type:`struct ieee80211_he_mcs_nss_supp <ieee80211_he_mcs_nss_supp>`\ , which are
both split into 8 subfields by number of streams. These values indicate
which MCSes are supported for the number of streams the value appears
for.

.. _`ieee80211_he_mcs_nss_supp`:

struct ieee80211_he_mcs_nss_supp
================================

.. c:type:: struct ieee80211_he_mcs_nss_supp

    HE Tx/Rx HE MCS NSS Support Field

.. _`ieee80211_he_mcs_nss_supp.definition`:
...
.. _`ieee80211_he_mcs_nss_supp.members`:

Members
-------

rx_mcs_80
    Rx MCS map 2 bits for each stream, total 8 streams, for channel
    widths less than 80MHz.

tx_mcs_80
    Tx MCS map 2 bits for each stream, total 8 streams, for channel
    widths less than 80MHz.
...
rx_mcs_80p80
    Rx MCS map 2 bits for each stream, total 8 streams, for
    channel width 80p80MHz.

tx_mcs_80p80
    Tx MCS map 2 bits for each stream, total 8 streams, for
    channel width 80p80MHz.

.. _`ieee80211_he_mcs_nss_supp.description`:
...
.. _`ieee80211_he_operation`:

struct ieee80211_he_operation
=============================

.. c:type:: struct ieee80211_he_operation

    HE capabilities element

.. _`ieee80211_he_operation.definition`:
...
.. _`ieee80211_he_operation.members`:
...
.. _`ieee80211_he_operation.description`:
...
.. _`ieee80211_he_mu_edca_param_ac_rec`:

struct ieee80211_he_mu_edca_param_ac_rec
========================================

.. c:type:: struct ieee80211_he_mu_edca_param_ac_rec

    MU AC Parameter Record field

.. _`ieee80211_he_mu_edca_param_ac_rec.definition`:
...
.. _`ieee80211_he_mu_edca_param_ac_rec.members`:
...
.. _`ieee80211_he_mu_edca_param_ac_rec.description`:
...
.. _`ieee80211_mu_edca_param_set`:

struct ieee80211_mu_edca_param_set
==================================

.. c:type:: struct ieee80211_mu_edca_param_set

    MU EDCA Parameter Set element

.. _`ieee80211_mu_edca_param_set.definition`:
...
.. _`ieee80211_mu_edca_param_set.members`:
...
.. _`ieee80211_mu_edca_param_set.description`:
...
.. _`ieee80211_get_vht_max_nss`:

ieee80211_get_vht_max_nss
=========================

.. c:function:: int ieee80211_get_vht_max_nss(struct ieee80211_vht_cap *cap, enum ieee80211_vht_chanwidth bw, int mcs, bool ext_nss_bw_capable)

    return max NSS for a given bandwidth/MCS

    :param cap:
        VHT capabilities of the peer
    :type cap: struct ieee80211_vht_cap \*

    :param bw:
        bandwidth to use
    :type bw: enum ieee80211_vht_chanwidth

    :param mcs:
        MCS index to use
    :type mcs: int

    :param ext_nss_bw_capable:
        indicates whether or not the local transmitter
        (rate scaling algorithm) can deal with the new logic
        (dot11VHTExtendedNSSBWCapable)
    :type ext_nss_bw_capable: bool

.. _`ieee80211_get_vht_max_nss.description`:
...
.. _`ieee80211_get_vht_max_nss.note`:

Note
----

This function is exported by cfg80211.
...
.. c:function:: u8 ieee80211_get_tid(struct ieee80211_hdr *hdr)
...
.. c:function:: bool ieee80211_check_tim(const struct ieee80211_tim_ie *tim, u8 tim_len, u16 aid)
    ...
    :param tim:
        the TIM IE
    :type tim: const struct ieee80211_tim_ie \*
