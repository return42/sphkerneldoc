...
BSS_CHANGED_MCAST_RATE
    Multicast Rate setting changed for this interface

BSS_CHANGED_FTM_RESPONDER
    fime timing reasurement request responder
...
bss_color
    6-bit value to mark inter-BSS frame, if BSS supports HE

htc_trig_based_pkt_ext
    default PE in 4us units, if BSS supports HE

multi_sta_back_32bit
    supports BA bitmap of 32-bits in Multi-STA BACK

uora_exists
    is the UORA element advertised by AP

ack_enabled
    indicates support to receive a multi-TID that solicits either
    ACK, BACK or both

uora_ocw_range
    UORA element's OCW Range field
...
ftm_responder
    whether to enable or disable fine timing measurement FTM
    responder functionality.

ftmr_params
    configurable lci/civic parameter when enabling FTM responder.
...
RX_FLAG_NO_PSDU
    ...
    in \ :c:type:`struct ieee80211_rx_status <ieee80211_rx_status>`\ .  Note that if this value isn't
...
encoding
    \ :c:type:`enum mac80211_rx_encoding <mac80211_rx_encoding>`\ 

bw
    \ :c:type:`enum rate_info_bw <rate_info_bw>`\ 

he_ru
    HE RU, from \ :c:type:`enum nl80211_he_ru_alloc <nl80211_he_ru_alloc>`\ 

he_gi
    HE GI, from \ :c:type:`enum nl80211_he_gi <nl80211_he_gi>`\ 
...
txqs_stopped
    per AC flag to indicate that intermediate TXQs are stopped,
...
IEEE80211_HW_DEAUTH_NEED_MGD_TX_PREP
    ...
    \ :c:func:`mgd_prepare_tx`\  callback to be called before transmission of a
...
.. c:function:: struct ieee80211_hw *ieee80211_alloc_hw_nm(size_t priv_data_len, const struct ieee80211_ops *ops, const char *requested_name)
    ...
    :type ops: const struct ieee80211_ops \*
...
.. c:function:: const char *ieee80211_create_tpt_led_trigger(struct ieee80211_hw *hw, unsigned int flags, const struct ieee80211_tpt_blink *blink_table, unsigned int blink_table_len)
    ...
    :type blink_table: const struct ieee80211_tpt_blink \*

    :param blink_table_len:
        size of the blink table
    :type blink_table_len: unsigned int
...
.. c:function:: void ieee80211_get_tx_rates(struct ieee80211_vif *vif, struct ieee80211_sta *sta, struct sk_buff *skb, struct ieee80211_tx_rate *dest, int max_rates)
    ...
    :type dest: struct ieee80211_tx_rate \*
...
.. c:function:: void ieee80211_sta_set_expected_throughput(struct ieee80211_sta *pubsta, u32 thr)
    ...
    :type pubsta: struct ieee80211_sta \*
...
.. _`ieee80211_tx_rate_update`:

ieee80211_tx_rate_update
========================

.. c:function:: void ieee80211_tx_rate_update(struct ieee80211_hw *hw, struct ieee80211_sta *pubsta, struct ieee80211_tx_info *info)
    ...
    :param pubsta:
        the station to update the tx rate for.
    :type pubsta: struct ieee80211_sta \*
...
.. _`ieee80211_tx_rate_update.description`:
...
.. c:function:: void ieee80211_tx_status_ext(struct ieee80211_hw *hw, struct ieee80211_tx_status *status)
    ...
    :param status:
        tx status information
    :type status: struct ieee80211_tx_status \*
...
.. c:function:: struct sk_buff *ieee80211_beacon_get_template(struct ieee80211_hw *hw, struct ieee80211_vif *vif, struct ieee80211_mutable_offsets *offs)
    ...
    :type offs: struct ieee80211_mutable_offsets \*
...
.. _`ieee80211_csa_set_counter`:

ieee80211_csa_set_counter
=========================

.. c:function:: void ieee80211_csa_set_counter(struct ieee80211_vif *vif, u8 counter)

    request mac80211 to set csa counter
...
.. _`ieee80211_csa_set_counter.description`:
...
It should never be used together with \ :c:func:`ieee80211_csa_update_counter`\ ,
...
.. c:function:: struct sk_buff *ieee80211_nullfunc_get(struct ieee80211_hw *hw, struct ieee80211_vif *vif, bool qos_ok)
    ...
    :param qos_ok:
        QoS NDP is acceptable to the caller, this should be set
        if at all possible
    :type qos_ok: bool
...
.. c:function:: void ieee80211_get_tkip_p1k_iv(struct ieee80211_key_conf *keyconf, u32 iv32, u16 *p1k)
    ...
    :type keyconf: struct ieee80211_key_conf \*
...
.. c:function:: void ieee80211_get_key_rx_seq(struct ieee80211_key_conf *keyconf, int tid, struct ieee80211_key_seq *seq)
    ...
    :type seq: struct ieee80211_key_seq \*
...
.. c:function:: void ieee80211_request_smps(struct ieee80211_vif *vif, enum ieee80211_smps_mode smps_mode)
    ...
    :param smps_mode:
        new SM PS mode
    :type smps_mode: enum ieee80211_smps_mode
...
.. c:function:: void ieee80211_mark_rx_ba_filtered_frames(struct ieee80211_sta *pubsta, u8 tid, u16 ssn, u64 filtered, u16 received_mpdus)
    ...
    :param received_mpdus:
        number of received mpdus in firmware
    :type received_mpdus: u16
...
.. _`ieee80211_manage_rx_ba_offl`:

ieee80211_manage_rx_ba_offl
===========================

.. c:function:: void ieee80211_manage_rx_ba_offl(struct ieee80211_vif *vif, const u8 *addr, unsigned int tid)

    helper to queue an RX BA work
...
.. _`rate_control_capabilities`:

enum rate_control_capabilities
==============================

.. c:type:: enum rate_control_capabilities

    rate control capabilities

.. _`rate_control_capabilities.definition`:
...
.. _`rate_control_capabilities.constants`:
...
.. c:function:: int rate_control_set_rates(struct ieee80211_hw *hw, struct ieee80211_sta *pubsta, struct ieee80211_sta_rates *rates)
    ...
    :type rates: struct ieee80211_sta_rates \*
...
.. c:function:: int ieee80211_parse_p2p_noa(const struct ieee80211_p2p_noa_attr *attr, struct ieee80211_noa_data *data, u32 tsf)
    ...
    :param attr:
        P2P NoA IE
    :type attr: const struct ieee80211_p2p_noa_attr \*

    :param data:
        NoA tracking data
    :type data: struct ieee80211_noa_data \*
...
.. c:function:: void ieee80211_tdls_oper_request(struct ieee80211_vif *vif, const u8 *peer, enum nl80211_tdls_operation oper, u16 reason_code, gfp_t gfp)
    ...
    :type oper: enum nl80211_tdls_operation
...
.. c:function:: void ieee80211_txq_get_depth(struct ieee80211_txq *txq, unsigned long *frame_cnt, unsigned long *byte_cnt)
    ...
    :type frame_cnt: unsigned long \*

    :param byte_cnt:
        pointer to store byte count
    :type byte_cnt: unsigned long \*
