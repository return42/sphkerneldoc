...
rssi
    relevant if \ :c:type:`struct type <type>`\  is \ ``RSSI_EVENT``\ 

mlme
    relevant if \ :c:type:`struct type <type>`\  is \ ``AUTH_EVENT``\ 

ba
    relevant if \ :c:type:`struct type <type>`\  is \ ``BAR_RX_EVENT``\  or \ ``BA_FRAME_TIMEOUT``\ 
