...
.. _`ieee80211_sta_he_cap`:

struct ieee80211_sta_he_cap
===========================

.. c:type:: struct ieee80211_sta_he_cap

    STA's HE capabilities

.. _`ieee80211_sta_he_cap.definition`:
...
.. _`ieee80211_sta_he_cap.members`:

Members
-------

has_he
    true iff HE data is valid.

he_cap_elem
    Fixed portion of the HE capabilities element.

he_mcs_nss_supp
    The supported NSS/MCS combinations.

ppe_thres
    Holds the PPE Thresholds data.

.. _`ieee80211_sta_he_cap.description`:
...
.. _`ieee80211_sband_iftype_data`:

struct ieee80211_sband_iftype_data
==================================

.. c:type:: struct ieee80211_sband_iftype_data


.. _`ieee80211_sband_iftype_data.definition`:
...
.. _`ieee80211_sband_iftype_data.members`:

Members
-------

types_mask
    interface types mask

he_cap
    holds the HE capabilities

.. _`ieee80211_sband_iftype_data.description`:
...
.. _`ieee80211_get_sband_iftype_data`:

ieee80211_get_sband_iftype_data
===============================

.. c:function:: const struct ieee80211_sband_iftype_data *ieee80211_get_sband_iftype_data(const struct ieee80211_supported_band *sband, u8 iftype)

    return sband data for a given iftype

    :param sband:
        the sband to search for the STA on
    :type sband: const struct ieee80211_supported_band \*

    :param iftype:
        enum nl80211_iftype
    :type iftype: u8

.. _`ieee80211_get_sband_iftype_data.return`:

Return
------

pointer to struct ieee80211_sband_iftype_data, or NULL is none found

.. _`ieee80211_get_he_sta_cap`:

ieee80211_get_he_sta_cap
========================

.. c:function:: const struct ieee80211_sta_he_cap *ieee80211_get_he_sta_cap(const struct ieee80211_supported_band *sband)

    return HE capabilities for an sband's STA

    :param sband:
        the sband to search for the STA on
    :type sband: const struct ieee80211_supported_band \*

.. _`ieee80211_get_he_sta_cap.return`:

Return
------

pointer to the struct ieee80211_sta_he_cap, or NULL is none found
...
.. c:function:: void cfg80211_chandef_create(struct cfg80211_chan_def *chandef, struct ieee80211_channel *channel, enum nl80211_channel_type chantype)
    ...
    :param chantype:
        the channel type
    :type chantype: enum nl80211_channel_type
...
.. c:function:: bool cfg80211_chandef_identical(const struct cfg80211_chan_def *chandef1, const struct cfg80211_chan_def *chandef2)
    ...
    :type chandef1: const struct cfg80211_chan_def \*

    :param chandef2:
        second channel definition
    :type chandef2: const struct cfg80211_chan_def \*
...
.. c:function:: int cfg80211_chandef_dfs_required(struct wiphy *wiphy, const struct cfg80211_chan_def *chandef, enum nl80211_iftype iftype)
    ...
    :type iftype: enum nl80211_iftype
...
lci
    LCI subelement content

civicloc
    Civic location subelement content
...
he_capa_len
    the length of the HE capabilities
...
.. c:function:: int cfg80211_check_station_change(struct wiphy *wiphy, struct station_parameters *params, enum cfg80211_station_type statype)
    ...
    :type params: struct station_parameters \*

    :param statype:
        the type of station being modified
    :type statype: enum cfg80211_station_type
...
he_gi
    HE guard interval (from \ :c:type:`enum nl80211_he_gi <nl80211_he_gi>`\ )

he_dcm
    HE DCM value

he_ru_alloc
    HE RU allocation (from \ :c:type:`enum nl80211_he_ru_alloc <nl80211_he_ru_alloc>`\ ,
...
.. _`cfg80211_txq_stats`:

struct cfg80211_txq_stats
=========================

.. c:type:: struct cfg80211_txq_stats

    TXQ statistics for this TID

.. _`cfg80211_txq_stats.definition`:
...
.. _`cfg80211_txq_stats.members`:

Members
-------

filled
    bitmap of flags using the bits of \ :c:type:`enum nl80211_txq_stats <nl80211_txq_stats>`\  to
    indicate the relevant values in this struct are filled

backlog_bytes
    total number of bytes currently backlogged

backlog_packets
    total number of packets currently backlogged

flows
    number of new flows seen

drops
    total number of packets dropped

ecn_marks
    total number of packets marked with ECN CE
...
tx_bytes
    total number of bytes dequeued

tx_packets
    total number of packets dequeued
...
.. c:function:: int cfg80211_get_station(struct net_device *dev, const u8 *mac_addr, struct station_info *sinfo)
    ...
    :type sinfo: struct station_info \*
...
CONNECT_REQ_EXTERNAL_AUTH_SUPPORT
    User space indicates external
    authentication capability. Drivers can offload authentication to
    userspace if this flag is set. Only applicable for \ :c:func:`cfg80211_connect`\ 
...
UPDATE_FILS_ERP_INFO
    Indicates that FILS connection parameters (realm,
    username, erp sequence number and rrk) are updated

UPDATE_AUTH_TYPE
    Indicates that authentication type is updated
...
.. _`cfg80211_external_auth_params`:

struct cfg80211_external_auth_params
====================================

.. c:type:: struct cfg80211_external_auth_params

    Trigger External authentication.

.. _`cfg80211_external_auth_params.definition`:
...
.. _`cfg80211_external_auth_params.members`:

Members
-------

action
    action type / trigger for external authentication. Only significant
    for the authentication request event interface (driver to user space).

bssid
    BSSID of the peer with which the authentication has
    to happen. Used by both the authentication request event and
    authentication response command interface.

ssid
    SSID of the AP.  Used by both the authentication request event and
    authentication response command interface.

key_mgmt_suite
    AKM suite of the respective authentication. Used by the
    authentication request event interface.

status
    status code, \ ``WLAN_STATUS_SUCCESS``\  for successful authentication,
    use \ ``WLAN_STATUS_UNSPECIFIED_FAILURE``\  if user space cannot give you
    the real status code for failures. Used only for the authentication
    response command interface (user space to driver).

.. _`cfg80211_external_auth_params.description`:
...
.. c:type:: enum wiphy_opmode_flag

    Station's ht/vht operation mode information flags

.. _`wiphy_opmode_flag.definition`:
...
.. _`wiphy_opmode_flag.constants`:

Constants
---------

STA_OPMODE_MAX_BW_CHANGED
    Max Bandwidth changed

STA_OPMODE_SMPS_MODE_CHANGED
    SMPS mode changed

STA_OPMODE_N_SS_CHANGED
    max N_SS (number of spatial streams) changed
...
.. c:type:: struct sta_opmode_info

    Station's ht/vht operation mode information

.. _`sta_opmode_info.definition`:
...
.. _`sta_opmode_info.members`:

Members
-------

changed
    contains value from \ :c:type:`enum wiphy_opmode_flag <wiphy_opmode_flag>`\ 

smps_mode
    New SMPS mode value from \ :c:type:`enum nl80211_smps_mode <nl80211_smps_mode>`\  of a station

bw
    new max bandwidth value from \ :c:type:`enum nl80211_chan_width <nl80211_chan_width>`\  of a station

rx_nss
    new rx_nss value of a station
...
.. c:function:: struct wiphy *wiphy_new_nm(const struct cfg80211_ops *ops, int sizeof_priv, const char *requested_name)
    ...
    :type ops: const struct cfg80211_ops \*
    ...
    :type requested_name: const char \*
...
.. c:function:: u32 ieee80211_mandatory_rates(struct ieee80211_supported_band *sband, enum nl80211_bss_scan_width scan_width)
    ...
    :param scan_width:
        width of the control channel
    :type scan_width: enum nl80211_bss_scan_width
...
.. c:function:: int ieee80211_data_to_8023_exthdr(struct sk_buff *skb, struct ethhdr *ehdr, const u8 *addr, enum nl80211_iftype iftype, u8 data_offset)
    ...
    :param data_offset:
        offset of payload after the 802.11 header
    :type data_offset: u8
...
.. c:function:: unsigned int cfg80211_classify8021d(struct sk_buff *skb, struct cfg80211_qos_map *qos_map)
    ...
    :type qos_map: struct cfg80211_qos_map \*
...
.. _`cfg80211_send_layer2_update`:

cfg80211_send_layer2_update
===========================

.. c:function:: void cfg80211_send_layer2_update(struct net_device *dev, const u8 *addr)

    send layer 2 update frame
...
.. _`cfg80211_send_layer2_update.description`:
...
.. c:function:: int regulatory_set_wiphy_regd(struct wiphy *wiphy, struct ieee80211_regdomain *rd)
    ...
    :type rd: struct ieee80211_regdomain \*
...
.. c:function:: void wiphy_apply_custom_regulatory(struct wiphy *wiphy, const struct ieee80211_regdomain *regd)
    ...
    :type regd: const struct ieee80211_regdomain \*
...
.. _`internal-regulatory-db-functions`:

Internal regulatory db functions
================================



.. _`reg_query_regdb_wmm`:

reg_query_regdb_wmm
===================

.. c:function:: int reg_query_regdb_wmm(char *alpha2, int freq, struct ieee80211_reg_rule *rule)

    Query internal regulatory db for wmm rule Regulatory self-managed driver can use it to proactively
    ...
    :param rule:
        pointer to store the wmm rule from the regulatory db.
    :type rule: struct ieee80211_reg_rule \*

.. _`reg_query_regdb_wmm.description`:
...
.. _`reg_query_regdb_wmm.return`:

Return
------

0 on success. -ENODATA.
...
.. c:function:: void cfg80211_scan_done(struct cfg80211_scan_request *request, struct cfg80211_scan_info *info)
    ...
    :type info: struct cfg80211_scan_info \*
...
.. c:function:: struct cfg80211_bss *cfg80211_inform_bss_frame_data(struct wiphy *wiphy, struct cfg80211_inform_bss *data, struct ieee80211_mgmt *mgmt, size_t len, gfp_t gfp)
    ...
    :param data:
        the BSS metadata
    :type data: struct cfg80211_inform_bss \*
...
.. c:function:: struct cfg80211_bss *cfg80211_inform_bss_data(struct wiphy *wiphy, struct cfg80211_inform_bss *data, enum cfg80211_bss_frame_type ftype, const u8 *bssid, u64 tsf, u16 capability, u16 beacon_interval, const u8 *ie, size_t ielen, gfp_t gfp)
    ...
    :param ftype:
        frame type (if known)
    :type ftype: enum cfg80211_bss_frame_type
...
.. c:function:: void cfg80211_michael_mic_failure(struct net_device *dev, const u8 *addr, enum nl80211_key_type key_type, int key_id, const u8 *tsc, gfp_t gfp)
    ...
    :type key_type: enum nl80211_key_type
...
.. _`cfg80211_fils_resp_params`:

struct cfg80211_fils_resp_params
================================

.. c:type:: struct cfg80211_fils_resp_params

    FILS connection response params

.. _`cfg80211_fils_resp_params.definition`:
...
.. _`cfg80211_fils_resp_params.members`:
...
.. c:function:: void cfg80211_connect_done(struct net_device *dev, struct cfg80211_connect_resp_params *params, gfp_t gfp)
    ...
    :type params: struct cfg80211_connect_resp_params \*
...
.. c:function:: void cfg80211_connect_bss(struct net_device *dev, const u8 *bssid, struct cfg80211_bss *bss, const u8 *req_ie, size_t req_ie_len, const u8 *resp_ie, size_t resp_ie_len, int status, gfp_t gfp, enum nl80211_timeout_reason timeout_reason)
    ...
    :type req_ie: const u8 \*

    :param req_ie_len:
        association request IEs length
    :type req_ie_len: size_t

    :param resp_ie:
        association response IEs (may be \ ``NULL``\ )
    :type resp_ie: const u8 \*

    :param resp_ie_len:
        assoc response IEs length
    :type resp_ie_len: size_t
    ...
    :param timeout_reason:
        ...
        failure is due to a timeout and not due to explicit rejection by the AP.
        This value is ignored in other cases (@status >= 0).
    :type timeout_reason: enum nl80211_timeout_reason
...
fils
    FILS related roaming information.
...
.. c:function:: void cfg80211_roamed(struct net_device *dev, struct cfg80211_roam_info *info, gfp_t gfp)
    ...
    :type info: struct cfg80211_roam_info \*
...
.. c:function:: void cfg80211_ready_on_channel(struct wireless_dev *wdev, u64 cookie, struct ieee80211_channel *chan, unsigned int duration, gfp_t gfp)
    ...
    :type chan: struct ieee80211_channel \*
...
.. _`cfg80211_sinfo_alloc_tid_stats`:

cfg80211_sinfo_alloc_tid_stats
==============================

.. c:function:: int cfg80211_sinfo_alloc_tid_stats(struct station_info *sinfo, gfp_t gfp)
...
.. _`cfg80211_sinfo_release_content`:

cfg80211_sinfo_release_content
==============================

.. c:function:: void cfg80211_sinfo_release_content(struct station_info *sinfo)

    release contents of station info

    :param sinfo:
        the station information
    :type sinfo: struct station_info \*

.. _`cfg80211_sinfo_release_content.description`:
...
.. c:function:: void cfg80211_conn_failed(struct net_device *dev, const u8 *mac_addr, enum nl80211_connect_failed_reason reason, gfp_t gfp)
    ...
    :type reason: enum nl80211_connect_failed_reason
...
.. _`cfg80211_rx_control_port`:

cfg80211_rx_control_port
========================

.. c:function:: bool cfg80211_rx_control_port(struct net_device *dev, struct sk_buff *skb, bool unencrypted)

    notification about a received control port frame
    ...
    :param skb:
        The skbuf with the control port frame.  It is assumed that the skbuf
    ...
    :param unencrypted:
        Whether the frame was received unencrypted
    :type unencrypted: bool

.. _`cfg80211_rx_control_port.description`:
...
.. _`cfg80211_rx_control_port.return`:

Return
------

\ ``true``\  if the frame was passed to userspace
...
.. c:function:: void cfg80211_cqm_rssi_notify(struct net_device *dev, enum nl80211_cqm_rssi_threshold_event rssi_event, s32 rssi_level, gfp_t gfp)
    ...
    :type rssi_event: enum nl80211_cqm_rssi_threshold_event
...
.. _`cfg80211_sta_opmode_change_notify`:

cfg80211_sta_opmode_change_notify
=================================

.. c:function:: void cfg80211_sta_opmode_change_notify(struct net_device *dev, const u8 *mac, struct sta_opmode_info *sta_opmode, gfp_t gfp)

    STA's ht/vht operation mode change event
    ...
    :param mac:
        MAC address of a station which opmode got modified
    :type mac: const u8 \*

    :param sta_opmode:
        station's current opmode value
    :type sta_opmode: struct sta_opmode_info \*

    :param gfp:
        context flags
    :type gfp: gfp_t

.. _`cfg80211_sta_opmode_change_notify.description`:
...
.. c:function:: void cfg80211_probe_status(struct net_device *dev, const u8 *addr, u64 cookie, bool acked, s32 ack_signal, bool is_valid_ack_signal, gfp_t gfp)
    ...
    :param ack_signal:
        signal strength (in dBm) of the ACK frame.
    :type ack_signal: s32

    :param is_valid_ack_signal:
        indicates the ack_signal is valid or not.
    :type is_valid_ack_signal: bool
...
.. c:function:: void cfg80211_ft_event(struct net_device *netdev, struct cfg80211_ft_event_params *ft_event)
    ...
    :param ft_event:
        IE information
    :type ft_event: struct cfg80211_ft_event_params \*
...
.. c:function:: int cfg80211_get_p2p_attr(const u8 *ies, unsigned int len, enum ieee80211_p2p_attr_id attr, u8 *buf, unsigned int bufsize)
    ...
    :type attr: enum ieee80211_p2p_attr_id
...
.. c:function:: size_t ieee80211_ie_split_ric(const u8 *ies, size_t ielen, const u8 *ids, int n_ids, const u8 *after_ric, int n_after_ric, size_t offset)
    ...
    :type after_ric: const u8 \*

    :param n_after_ric:
        size of the \ ``after_ric``\  array
    :type n_after_ric: int
...
.. c:function:: void cfg80211_report_wowlan_wakeup(struct wireless_dev *wdev, struct cfg80211_wowlan_wakeup *wakeup, gfp_t gfp)
    ...
    :param wakeup:
        the wakeup report
    :type wakeup: struct cfg80211_wowlan_wakeup \*
...
.. c:function:: int cfg80211_check_combinations(struct wiphy *wiphy, struct iface_combination_params *params)
    ...
    :type params: struct iface_combination_params \*
...
.. c:function:: void wiphy_ext_feature_set(struct wiphy *wiphy, enum nl80211_ext_feature_index ftidx)
    ...
    :type ftidx: enum nl80211_ext_feature_index
...
.. c:function:: void cfg80211_free_nan_func(struct cfg80211_nan_func *f)
    ...
    :type f: struct cfg80211_nan_func \*
...
.. c:function:: void cfg80211_nan_match(struct wireless_dev *wdev, struct cfg80211_nan_match_params *match, gfp_t gfp)
    ...
    :type match: struct cfg80211_nan_match_params \*
...
.. c:function:: void cfg80211_nan_func_terminated(struct wireless_dev *wdev, u8 inst_id, enum nl80211_nan_func_term_reason reason, u64 cookie, gfp_t gfp)
    ...
    :type reason: enum nl80211_nan_func_term_reason
...
.. _`cfg80211_external_auth_request`:

cfg80211_external_auth_request
==============================

.. c:function:: int cfg80211_external_auth_request(struct net_device *netdev, struct cfg80211_external_auth_params *params, gfp_t gfp)

    userspace request for authentication
    ...
    :type params: struct cfg80211_external_auth_params \*

    :param gfp:
        allocation flags
    :type gfp: gfp_t

.. _`cfg80211_external_auth_request.return`:
