...
band_pref
    preferred band for \ ``NL80211_BSS_SELECT_ATTR_BAND_PREF``\ .

adjust
    parameters for \ ``NL80211_BSS_SELECT_ATTR_RSSI_ADJUST``\ .
...
authorized
    true if the 802.1X authentication was done by the driver or is
