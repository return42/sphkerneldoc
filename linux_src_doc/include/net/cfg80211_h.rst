...
.. c:function:: int reg_query_regdb_wmm(char *alpha2, int freq, u32 *ptr, struct ieee80211_wmm_rule *rule)
    ...
    :param u32 \*ptr:
        pointer where the regdb wmm data is to be stored (or \ ``NULL``\  if
        irrelevant). This can be used later for deduplication.

    :param struct ieee80211_wmm_rule \*rule:
...
.. c:function:: void cfg80211_sta_opmode_change_notify(struct net_device *dev, const u8 *mac, struct sta_opmode_info *sta_opmode, gfp_t gfp)
    ...
    :param struct sta_opmode_info \*sta_opmode:
...
.. c:function:: void cfg80211_probe_status(struct net_device *dev, const u8 *addr, u64 cookie, bool acked, s32 ack_signal, bool is_valid_ack_signal, gfp_t gfp)
    ...
    :param s32 ack_signal:
        signal strength (in dBm) of the ACK frame.

    :param bool is_valid_ack_signal:
...
.. c:function:: int cfg80211_external_auth_request(struct net_device *netdev, struct cfg80211_external_auth_params *params, gfp_t gfp)
    ...
    :param struct cfg80211_external_auth_params \*params:
