...
vht_mumimo_groups
    MU-MIMO groupID. used for monitoring only
...
dual
    dual band operation mode, see \ :c:type:`enum nl80211_nan_dual_band_conf <nl80211_nan_dual_band_conf>`\ 
...
connect
    ...
    \ :c:func:`cfg80211_roamed`\  or \ :c:func:`cfg80211_roamed_bss`\ .
    (invoked with the wireless_dev mutex held)

disconnect
    Disconnect from the BSS/ESS. Once done, call
    \ :c:func:`cfg80211_disconnected`\ .
    (invoked with the wireless_dev mutex held)
...
nan_started
    true if this is a NAN interface that has been started
...
.. c:function:: void cfg80211_connect_bss(struct net_device *dev, const u8 *bssid, struct cfg80211_bss *bss, const u8 *req_ie, size_t req_ie_len, const u8 *resp_ie, size_t resp_ie_len, int status, gfp_t gfp)
...
.. c:function:: void cfg80211_connect_timeout(struct net_device *dev, const u8 *bssid, const u8 *req_ie, size_t req_ie_len, gfp_t gfp)
