...
.. src-file: sound/soc/codecs/rt5668.c

.. _`rt5668_sel_asrc_clk_src`:

rt5668_sel_asrc_clk_src
=======================

.. c:function:: int rt5668_sel_asrc_clk_src(struct snd_soc_component *component, unsigned int filter_mask, unsigned int clk_src)
...
.. _`rt5668_sel_asrc_clk_src.description`:
...
.. _`rt5668_headset_detect`:

rt5668_headset_detect
=====================

.. c:function:: int rt5668_headset_detect(struct snd_soc_component *component, int jack_insert)
...
.. _`rt5668_headset_detect.description`:
