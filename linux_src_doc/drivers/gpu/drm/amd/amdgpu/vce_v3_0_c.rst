...
.. src-file: drivers/gpu/drm/amd/amdgpu/vce_v3_0.c
...
.. c:function:: uint64_t vce_v3_0_ring_get_rptr(struct amdgpu_ring *ring)
...
.. c:function:: uint64_t vce_v3_0_ring_get_wptr(struct amdgpu_ring *ring)
